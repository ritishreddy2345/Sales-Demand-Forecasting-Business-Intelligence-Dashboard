...
- **Data Pipeline**: Synthetic retail data generation to ETL to Google BigQuery
- **Customer Analytics**: RFM segmentation and BigQuery ML K-Means clustering
- **Demand Forecasting**: Facebook Prophet and ARIMA time-series models
...
python main.py 1 2                              # Phases 1 and 2 only
python main.py 3 4                              # Phases 3 and 4 only
python main.py 1 3                              # Phases 1 and 3, skip 2 and 4
...
3. Add roles: BigQuery Admin, BigQuery Data Editor, and BigQuery ML Admin
...
* Compare multiple models (Prophet and ARIMA)
